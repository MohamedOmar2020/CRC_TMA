...
def draw_voronoi_scatter(spot, c, voronoi_palette=sns.color_palette('bright'), scatter_palette='voronoi', X='x',
                         Y='y', voronoi_hue='neighborhood10', scatter_hue='cell_types',
                         figsize=(5, 5),
                         voronoi_kwargs={},
                         scatter_kwargs={}):
...
spot = cells2[cells2['Region']=='reg001_A']

_ = draw_voronoi_scatter(spot,[],)
plt.show()
plt.savefig('figures/voroni_reg059A.png')
